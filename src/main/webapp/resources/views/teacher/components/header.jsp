...
<!-- ==================================================================================== -->
<!-- If user not logged in as teacher then redirect to login -->
...
<div class="header">
	...
	<div class="header-left">
		...
		<a href="/teacher/dashboard" class="logo logo-small"> 
	...
	<ul class="nav user-menu">
		...
		<li class="nav-item dropdown noti-dropdown"><a href="#"
			class="dropdown-toggle nav-link" data-bs-toggle="dropdown"> <i
				class="far fa-bell"></i> <span class="badge badge-pill">2</span>
		</a>
								...
								<div class="media d-flex">
									...
									<div class="media-body flex-grow-1">
										<p class="noti-details">
											<span class="noti-title">Administrator</span> has approved <span
												class="noti-title">your document 01</span>
										</p>
										<p class="noti-time">
						...
						<li class="notification-message"><a href="#">
								<div class="media d-flex">
									...
									<div class="media-body flex-grow-1">
										<p class="noti-details">
											<span class="noti-title">Administrator</span> has approved <span
												class="noti-title">your document 02</span>
										</p>
										<p class="noti-time">
		...
		<li class="nav-item dropdown has-arrow"><a href="#"
			...
			<span class="user-img">
				<img class="rounded-circle" src="${user.profile_photo != null ? user.profile_photo : '/resources/images/user.png' }" 
					width="31" alt="${user.name != null ? user.name : 'Teacher img' }">
			</span>
		</a>
