			...
			<form action="/login" method="POST">
				...
				<div class="social__media__container">
					<a href="https://www.google.com/" target="_blank"
						class="social google"> <i class="fa-brands fa-google"></i>
					</a> <a href="https://www.facebook.com/" target="_blank"
						class="social facebook"> <i class="fa-brands fa-facebook"></i>
					</a>
				</div>
				<span class="under__social"> <a href="#"
					class="link signup-link"><small>or sign in with account</small></a>
				</span>
				...
				<div class="button-input-group">
					...
					<div class="group button-group">
						<button class="signin-btn" type="submit" name="submit">Sign
							in</button>
					</div>
				</div>
			</form>
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-right text-dark">
					...
					<p>Please contact the School Registration Manager or Class
						Teacher if you do not have login access.</p>
					<footer>
						<p>
							<small>School Information Management System</small>
						</p>
					</footer>
				</div>
			</div>
